          ...
          <div className="flex items-center justify-center flex-wrap gap-y-9 gap-x-5">
            <div className="w-[500px] h-[300px] bg-blue-950 rounded-lg overflow-hidden group relative">
              ...
              <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-black to-blue-600/75 translate-y-full  group-hover:translate-y-0 transition-transform duration-300 p-3">
                ...
                <p className="text-base font-semibold text-gray-300">
                  It is micro blogging website build using Nextjs 13. All
                  API&apos;s are developed with nextjs.It has functionalities
                  like authentication, authorization , edit by owner, like and
                  delete of Blogs. It uses NextUI library for modular components
            ...
            <div className="w-[500px] h-[300px] bg-blue-950 rounded-lg  overflow-hidden group relative">
              ...
              <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-black to-blue-600/75 translate-y-full  group-hover:translate-y-0 transition-transform duration-300 p-3">
                ...
                <p className="text-base font-semibold text-gray-300">
                  Full stack spotify clone, build using nextjs and supabase. You
                  can upload , like , and play song. User authentication for
            ...
            <div className="w-[500px] h-[300px] bg-blue-950 rounded-lg overflow-hidden group relative">
              ...
              <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-black to-blue-600/75 translate-y-full  group-hover:translate-y-0 transition-transform duration-300 p-3">
                ...
                <p className="text-base font-semibold text-gray-300">
                  ...
                  material-ui. For products ,Uses dummy-json API . It has home
            ...
            <div className="w-[500px] h-[300px] bg-blue-950 rounded-lg overflow-hidden group relative">
              ...
              <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-black to-blue-600/75 translate-y-full  group-hover:translate-y-0 transition-transform duration-300 p-3">
                ...
                <p className="text-base font-semibold text-gray-300">
                  Command line tool to setup react application using Parcel
                  bundler. In built support for tailwind css, jest and
                  TypeScript.Parcel is blazing fast, zero configuration web
                  application bundler.
                </p>
                <div className="flex gap-x-5">
                  <a

...
const experience: ExperienceType[] = [
  {
    ...
    description:
      `
      My day to day task include building and designing websites frontend.Making re-usable components for maximum modularity in the website. Web optimization for maximum
      web performance. Working on new features that can be build without any external package. Reviewing and refactoring existing code.
      `
  },
  {
    id: 1,
  ...
  },
  {
    ...
    tenure: "January 2023 - April 2024",
    description:
